      ...
      <div className="max-w-4xl space-y-8">
        {currentStep === 'setup' && isNewProject ? (
          ...
          <>
              ...
              <div className="text-sm text-blue-800 space-y-2">
                {isAddingToProject ? (
                  <>
                    ...
                    <p>• Contract analysis will be refreshed to include all documents (old + new)</p>
                    <p>• Changes and updates will be detected using all stored text</p>
                  </>
                ) : (
                  <>
                    <p>• Upload your base contract and any amendments or related documents</p>
            ...
            {/* Upload Summary - Pass classification result and files for accurate counts */}
            <UploadSummary
              stats={stats}
